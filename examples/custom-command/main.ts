...
async function demo() {
	...
	if (process.env.AI_GATEWAY_API_KEY) {
		const url =
			'https://failtowin.substack.com/p/ai-automation-promises-and-pitfalls'

		console.log(
			`9. Summarize URL to markdown file (using @steipete/summarize-core):`
		)
		...
		console.log(
			'9-11. Skipping summarize demos (set AI_GATEWAY_API_KEY to enable)\n'
		)
	}
}
